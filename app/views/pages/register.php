...
<div style="display:flex;width:100%;">
    ...
    <form action="<?php echo URLROOT; ?>/portal/register" method="post">
      ...
      <div style="width:40%;"  class="pull-right">
        ...
        <div style="width:100%;" class="sel sel--black-panther
            <?php echo (!empty($data['position_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['dept']; ?>">
         <span class="invalid-feedback"><?php echo $data['position_err']; ?></span>
        <select name="dept" id="select-profession">
          <option value="" disabled>Second Choice</option>
            <?php foreach ($data['depts'] as $position) : ?>
             <option value="<?php echo $position->deptID; ?>" ><?php echo $position->deptName; ?></option>
            <?php endforeach; ?>
        </select>
        </div>
        <div style="width:100%;">
